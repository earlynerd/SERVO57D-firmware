...
The standalone step/direction decoder and portable d/q current controller
remain separately compiled and unlinked for future integration; the superseded
general application/servo shell has been retired.
