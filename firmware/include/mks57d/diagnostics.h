...
enum
{
    ...
    DIAGNOSTICS_CAPABILITY_CURRENT_DIAGNOSTIC = 1u << 11,
    ...
    DIAGNOSTICS_CAPABILITY_ALIGNED_TORQUE = 1u << 15,
    DIAGNOSTICS_CAPABILITY_VELOCITY_CONTROL = 1u << 16,
