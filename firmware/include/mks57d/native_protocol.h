...
enum
{
    ...
    NATIVE_PROTOCOL_VERSION_MINOR = 20u,
...
typedef enum
{
    ...
    NATIVE_PROTOCOL_COMMAND_GET_RUNTIME_PROFILE = 0x0108u,
    NATIVE_PROTOCOL_COMMAND_ARM_RUNTIME_PROFILE = 0x0109u,
    NATIVE_PROTOCOL_COMMAND_START_BOOTSTRAP_PROBE = 0x010Au,
