...
typedef enum
{
    ...
    SERVO_FAULT_INVALID_FEEDBACK = 1u << 1,
    SERVO_FAULT_STALE_FEEDBACK = 1u << 2,
...
typedef struct
{
    ...
    uint32_t feedback_stale_timeout_us;
...
typedef struct
{
    ...
    float feedback_position_revolutions;
    float feedback_velocity_revolutions_per_second;
