...
- An inactive, bounded ADC layer preserves the provisional PA1 `currentB`, PA2 `currentA`, and PA3 `vBus` raw-sample contract without enabling ADC/HSI or configuring those analog pins at boot.
