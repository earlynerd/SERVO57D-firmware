...
- SPI magnetic encoder; exact fitted device marking remains to be confirmed on hardware.
...
- Encoder device marking, SPI mode, resolution, and magnet orientation.
...
- Bus-voltage divider mapping and safe ADC range.
