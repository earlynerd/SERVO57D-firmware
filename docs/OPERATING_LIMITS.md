...
Status: firmware 0.23.2 separates the bench-validated envelope from the larger
...
| Quantity | Firmware 0.23.2 value | Class and basis | Enforcement owner | Status / next evidence |
| --- | ---: | --- | --- | --- |
