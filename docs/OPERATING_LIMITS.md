...
Status: firmware 0.23.1 separates the bench-validated envelope from the larger
...
| Quantity | Firmware 0.23.1 value | Class and basis | Enforcement owner | Status / next evidence |
| --- | ---: | --- | --- | --- |
